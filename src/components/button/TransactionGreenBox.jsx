...
const TransactionGreenBox = ({onPress, productImages, placeholderDate, placeholderName, placeholderNumber, placeholderPrice}) => {
        ...
        <TouchableOpacity onPress={onPress}>
            <View style={styles.transactionBox}>
                <View style={styles.transactionHeader}>
                    ...
                    <Text style={styles.transactionStatus}>Selesai</Text>
                </View>
                ...
                <View style={styles.transactionBottom}>
                    ...
                    <View style={styles.reviewOrBuy}>
                        <NoFillButton onPress={() => navigation.navigator()} placeholder={"Ulas"}/>
...
export default TransactionGreenBox