...
const WaitingPaymentDetailBox = ({onPress, placeholderShopName, productImages, placeholderName, placeholderNumber, placeholderPrice}) => {
                ...
                <View style={styles.transactionBox}>
                    ...
                    <View style={styles.transactionBottom}>
                        ...
                        <View style={styles.reviewOrBuy}>
                            <NoFillButton onPress={() => navigation.navigator()} placeholder={"Edit"}/>
                        </View>
                    </View>
                </View>
            </TouchableOpacity>
...
export default WaitingPaymentDetailBox