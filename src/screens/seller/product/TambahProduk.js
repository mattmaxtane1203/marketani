import { SafeAreaView, KeyboardAvoidingView, Text, View, StyleSheet, TouchableWithoutFeedback, ScrollView } from "react-native";
        ...
        <TouchableWithoutFeedback>
          <ScrollView>
            <View style={styles.container}>
              ...
              <PrimaryButton placeholder={"Tambahkan"} onPress={() => navigation.goBack()}/>
            </View>
          </ScrollView>
        </TouchableWithoutFeedback>
      </KeyboardAvoidingView>
