...
const DetailPesananSelesai = ({ navigation, route }) => {
        ...
        {currentTransactionStatus === "Terkirim" && (
          <View>
            ...
            >
              ...
              >
                <Text>
                  Harap periksa kembali jika pesanan sesuai dengan yang dipesan.
                  Jika sesuai, tekan tombol SELESAI. Jika tidak, chat dengan
                  toko.
                </Text>
              </View>
              <TouchableOpacity
